...
class PartidaResourceIT {
    ...
    private static final String DEFAULT_JUEGO = "AAAAAAAAAA";
    private static final String UPDATED_JUEGO = "BBBBBBBBBB";
    ...
    public static Partida createEntity(EntityManager em) {
        Partida partida = new Partida().puntos(DEFAULT_PUNTOS).juego(DEFAULT_JUEGO);
        return partida;
    }
    ...
    public static Partida createUpdatedEntity(EntityManager em) {
        Partida partida = new Partida().puntos(UPDATED_PUNTOS).juego(UPDATED_JUEGO);
        return partida;
    }
    ...
    void createPartida() throws Exception {
        ...
        assertThat(testPartida.getJuego()).isEqualTo(DEFAULT_JUEGO);
    }
    ...
    @Test
    @Transactional
    void checkJuegoIsRequired() throws Exception {
        int databaseSizeBeforeTest = partidaRepository.findAll().size();
        // set the field null
    ...
    void getAllPartidas() throws Exception {
        ...
        restPartidaMockMvc
            ...
            .andExpect(jsonPath("$.[*].juego").value(hasItem(DEFAULT_JUEGO)));
    }
    ...
    void getPartida() throws Exception {
        ...
        restPartidaMockMvc
            ...
            .andExpect(jsonPath("$.juego").value(DEFAULT_JUEGO));
    }
    ...
    void putNewPartida() throws Exception {
        ...
        updatedPartida.puntos(UPDATED_PUNTOS).juego(UPDATED_JUEGO);
        ...
        assertThat(testPartida.getJuego()).isEqualTo(UPDATED_JUEGO);
    }
    ...
    void fullUpdatePartidaWithPatch() throws Exception {
        ...
        partialUpdatedPartida.puntos(UPDATED_PUNTOS).juego(UPDATED_JUEGO);
