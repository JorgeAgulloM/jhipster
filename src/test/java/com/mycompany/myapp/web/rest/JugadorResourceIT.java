...
class JugadorResourceIT {
    ...
    @Test
    @Transactional
    void checkNacimientoIsRequired() throws Exception {
        int databaseSizeBeforeTest = jugadorRepository.findAll().size();
        // set the field null
    ...
    void putNewJugador() throws Exception {
        ...
        updatedJugador.apodo(UPDATED_APODO).nombre(UPDATED_NOMBRE).apellido(UPDATED_APELLIDO).nacimiento(UPDATED_NACIMIENTO);
    ...
    void fullUpdateJugadorWithPatch() throws Exception {
        ...
        partialUpdatedJugador.apodo(UPDATED_APODO).nombre(UPDATED_NOMBRE).apellido(UPDATED_APELLIDO).nacimiento(UPDATED_NACIMIENTO);
